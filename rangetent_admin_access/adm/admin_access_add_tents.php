...
<table>
<form action="admin_access_add_tents.php" method="POST" enctype="multipart/form-data">
<tr><td>Tent Name</td><td><input type="text" name="title" required></td></tr>
<tr><td>Category</td><td><select type="text" name="category" required>
...
<textarea rows="8" cols="55" name='description' required></textarea></td></tr>
<tr><td>Add image <input type="file" name="photo" required></td></tr>
